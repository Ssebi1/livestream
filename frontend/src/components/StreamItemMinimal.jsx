...
function StreamItemMinimal({stream}) {
    return (
        <div className="stream-item">
            <Link to={{pathname: `/stream/${stream._id}`}}><div className="thumbnail" style={{ backgroundImage:"url('https://q5n8c8q9.rocketcdn.me/wp-content/uploads/2019/09/YouTube-thumbnail-size-guide-best-practices-top-examples.png')" }}></div></Link>
