        ...
        <div className="stream-item" style={style}>
            ...
            <div className="stream-info">
                <div className="stream-info-left">
                    <Link to={{pathname: `/profile/${stream.user._id}`}}><div className="stream-author-image" style={{backgroundImage: `url('/profile-pictures/${stream.user._id}.png'), url('/defaults/profile-image.png')`}}></div></Link>
                </div>
