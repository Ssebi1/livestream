...
function StreamItem({stream, style}) {
    return (
        <div className="stream-item" style={style}>
            <Link to={{pathname: `/stream/${stream._id}`}}><div className="thumbnail" background-image="url('https://q5n8c8q9.rocketcdn.me/wp-content/uploads/2019/09/YouTube-thumbnail-size-guide-best-practices-top-examples.png')"></div></Link>
